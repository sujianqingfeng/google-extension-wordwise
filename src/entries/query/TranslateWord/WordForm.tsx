...
export default function WordForm(props: WordFormProps) {
	...
	return (
		<div className="group inline-flex items-center gap-1 px-2 py-1 ww-gradient-chip-emerald rounded border border-emerald-200/50 dark:border-emerald-700/50 transition-all duration-200 hover:shadow-soft hover:-translate-y-0.5">
			{/* 词性标签 */}
